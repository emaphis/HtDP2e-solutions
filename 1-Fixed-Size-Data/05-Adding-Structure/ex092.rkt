...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname chameleon1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (render vc)
  (place-image/align
   ...
   5 10 "left" "top"
   (place-image CHAM (vcham-x-pos vc) DY (new-scene (vcham-clr vc)))))
