...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname rocket2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (show x)
  (cond
    [(string? x)
     (place-image ROCKET 10 (- CENTER 0) BACKG)]
    [(<= -3 x -1)
     (place-image (text (number->string x) 20 "red")
                  ...
                  (place-image ROCKET
                               ...
                               BACKG))]
    [(>= x 0)
     (place-image ROCKET 10 (- CENTER x) BACKG)]))
