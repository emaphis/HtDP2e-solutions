...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 06_04_cat_cham_3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (happy-pet va)
  (big-bang va                       ; VAnima
            [check-with vanimal?]    ; Any -> Boolean
